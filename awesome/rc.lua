...
-- Textclock
mytextclock = awful.widget.textclock("<span font='Meslo LG M 5'> </span>%H:%M ")
...
mailwidget = lain.widgets.imap({
    ...
    settings = function()
        ...
        if mailcount > 0 then
            mail = "<span font='Meslo LG M 5'> </span>Mail "
            count = mailcount .. " "
        end
...
mpdwidget = lain.widgets.mpd({
    settings = function()
        if mpd_now.state == "play" then
            title = mpd_now.title
            artist  = " - " .. mpd_now.artist  .. markup("#333333", " |<span font='Meslo LG M 3'> </span>")
            mpdicon:set_image(beautiful.play)
        elseif mpd_now.state == "pause" then
            title = "mpd "
            artist  = "paused" .. markup("#333333", " |<span font='Meslo LG M 3'> </span>")
...
-- Weather
yawn = lain.widgets.yawn(2122641)

-- Separators
spr = wibox.widget.textbox(' ')
small_spr = wibox.widget.textbox('<span font="Meslo LG M 4"> </span>')
bar_spr = wibox.widget.textbox('<span font="Meslo LG M 3"> </span>' .. markup("#333333", "|") .. '<span font="Meslo LG M 3"> </span>')
